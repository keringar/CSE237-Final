...
struct nrsc5_t
{
    ...
    xrtKernelHandle fir_q15_execute_decim_kernel;
	xrtRunHandle fir_q15_execute_decim_run;
	xrtBufferHandle fir_q15_execute_decim_input;
	xrtBufferHandle fir_q15_execute_decim_output;

	xrtKernelHandle fir_q15_execute_fm_kernel;
