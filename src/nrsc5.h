...
int nrsc5_open(nrsc5_t **, int device_index, const char* xcl_bin);
int nrsc5_open_file(nrsc5_t **, FILE *fp, const char* xcl_bin);
int nrsc5_open_pipe(nrsc5_t **, const char* xcl_bin);
int nrsc5_open_rtltcp(nrsc5_t **, int socket, const char* xcl_bin);
